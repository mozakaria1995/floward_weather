...
// in floward_weather/test/features/weather/presentation/bloc/weather_bloc_test.dart.
...
import 'package:floward_weather/core/error/failures.dart' as _i6;
...
class MockGetWeather extends _i1.Mock implements _i4.GetWeather {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i7.Weather>> call(_i4.NoParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [params],
